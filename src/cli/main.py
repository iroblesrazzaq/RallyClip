...
def main() -> int:
    ...
    p.add_argument("--model-path", help="Legacy compatibility path to LSTM .pth")
    p.add_argument("--scaler-path", help="Legacy compatibility path to StandardScaler .joblib")
    ...
    p.add_argument("--fps", type=float, help="Advanced override for artifact FPS")
    p.add_argument("--seq-len", type=int, help="Advanced override for artifact sequence length")
    p.add_argument("--overlap", type=int, help="Advanced override for artifact overlap")
    p.add_argument("--sigma", type=float, help="Advanced override for artifact smoothing sigma")
    p.add_argument("--low", type=float, help="Advanced override for artifact hysteresis low threshold")
    p.add_argument("--high", type=float, help="Advanced override for artifact hysteresis high threshold")
    p.add_argument("--min-dur-sec", type=float, help="Advanced override for artifact minimum segment duration")
