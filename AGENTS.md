...
- - Before pushing commits or opening a PR, run `greptile review --branch main --agent`  
  from the repo root and address the findings (re-run until clean or justified). Specifics in docs/VERSION_CONTROL.md
