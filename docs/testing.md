...
Last known (2026-09-07, artifact-registry, Linux py3.12):
**297 passed, 6 skipped, 27 deselected, ~20s**. `tests/test_release_packaging.py` 21 passed;
`tests/test_artifact_fetch.py` 5 passed.
