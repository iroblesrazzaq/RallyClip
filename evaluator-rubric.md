...
| Verification | Required checks were not run or evidence is missing. | Some checks were run, but evidence is incomplete or indirect. | Required checks actually ran and evidence is recorded. |
...
- Block: total score is 0-5, verification is absent, or the work cannot be evaluated safely.
